...
abstract class Game extends Canvas {
	private static final long serialVersionUID = 564108756969519839L;
	...
	/*
	 * 'update' paints to a buffer then to the screen, then waits a tenth of a
	 * second before repeating itself, assuming the game is on. This is done to
	 * avoid a choppy painting experience if repainted in pieces.
	 */
